...
export const POINTER_EVENTS = {
  enabled: "all",
  disabled: "none",
  inheritFromUI: "var(--ui-pointerEvents)" as unknown as React.CSSProperties["pointerEvents"],
} as const;
...
export const getFontFamilyFallbacks = (
  ...
  switch (fontFamily) {
    case FONT_FAMILY["DFVN-Excalifont"]:
...
export const DEFAULT_FONT_FAMILY: FontFamilyValues = FONT_FAMILY["DFVN-Excalifont"];
